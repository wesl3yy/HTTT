    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center">
                ...
                <!-- <a href="index.jsp" class="logo me-auto"><img src="survey/assets/img/logo.png" alt="" class="img-fluid"></a>-->

                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        <li><a class="nav-link scrollto active" href="#hero">Trang chủ</a></li>
                        <li><a class="nav-link scrollto" href="#counts">Về chúng tôi</a></li>
                        <li><a class="nav-link scrollto" href="#services">Tư vấn sức khỏe</a></li>
                        <li><a class="nav-link scrollto" href="#doctors">Liên hệ bác sĩ</a></li>
                    </ul>
                    <i class="bi bi-list mobile-nav-toggle"></i>
                </nav><!-- .navbar -->

                <a href="topic" class="appointment-btn scrollto"><span class="d-none d-md-inline">Bắt đầu</span></a>
        ...
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
                <h1>Chào mừng đến với Health Care</h1>
                <h2>Dịch vụ chăm sóc, tư vấn sức khỏe người cao tuổi</h2>
                <a href="topic.jsp" class="btn-get-started scrollto">Bắt đầu</a>
            </div>
        </section><!-- End Hero -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 d-flex align-items-stretch">
                            <div class="content">
                                <h3>Tại sao chọn HEALTH CARE ?</h3>
                                <p>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 d-flex align-items-stretch">
                                        <div class="icon-box mt-4 mt-xl-0">
                                            ...
                                            <h4>Dinh dưỡng</h4>
                                            <p>Những thay đổi về dinh dưỡng người già có thể ảnh hưởng tới cơ chế hấp thụ thức ăn của cơ thể, nhu cầu dinh dưỡng và khẩu vị</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 d-flex align-items-stretch">
                                        <div class="icon-box mt-4 mt-xl-0">
                                            ...
                                            <h4>Nhận thức</h4>
                                            <p> Sa sút trí tuệ là một trong những bệnh điển hình nhất mà người cao tuổi ở Việt Nam thường mắc phải.</p>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 d-flex align-items-stretch">
                                        <div class="icon-box mt-4 mt-xl-0">
                                            ...
                                            <h4>Vận động</h4>
                                            <p>Việc vận động, tập thể dục đối với người trên 60 tuổi rất quan trọng. Bởi từ độ tuổi này, các chuyển hóa, chức năng của các cơ quan, bộ phận trong cơ thể đều suy giảm</p>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- End .content-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="survey/assets/img/doctors/doctors-1.jpg" class="img-fluid" alt=""></div>
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="survey/assets/img/doctors/doctors-2.jpg" class="img-fluid" alt=""></div>
                                <div class="member-info">
                                    <h4>Sarah Jhonson</h4>
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="survey/assets/img/doctors/doctors-3.jpg" class="img-fluid" alt=""></div>
                                <div class="member-info">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img src="survey/assets/img/doctors/doctors-4.jpg" class="img-fluid" alt=""></div>
                                <div class="member-info">
                                    <h4>Amanda Jepson</h4>
